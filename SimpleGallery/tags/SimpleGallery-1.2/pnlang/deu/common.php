...
define('_SIMPLEGALLERY_ALBUMLIST_SORTING',      'Albumreihenfolge');
define('_SIMPLEGALLERY_ALBUM_ORDER_CR_ASC',     'Erstellung / aufsteigend');
define('_SIMPLEGALLERY_ALBUM_ORDER_CR_DESC',    'Erstellung / absteigend');
define('_SIMPLEGALLERY_ALBUM_ORDER_LU_ASC',     'Aktualisierung / aufsteigend');
define('_SIMPLEGALLERY_ALBUM_ORDER_LU_DESC',    'Aktualisierung / absteigend');
define('_SIMPLEGALLERY_ALBUM_ORDER_TITLE_AZ',   'Nach Titel A-Z');
define('_SIMPLEGALLERY_ALBUM_ORDER_TITLE_ZA',   'Nach Titel Z-A');
