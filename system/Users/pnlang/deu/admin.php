...
// change account data 
define('_USERS_SENDMAILHINT', 'Die folgende E-Mail wird von der unten angegebenen Antwort-an-Adresse an die eigene E-Mail-Adresse verschickt. Die markierten Empfänger werden unter Blindkopie aufgeführt. Die Anzahl der Blindkopie-Empfänger je Vorgang kann vorab festgelegt werden. Falls die Anzahl der ausgewählten Benutzer größer als dieser Wert ist, wird ein zusätzlicher Mailversand durchgeführt. Die maximal mögliche Anzahl der Vorgänge hängt vom jeweiligen Hoster ab!');
define('_USERS_MAILINFOINSUFFICIENT', 'Ein oder mehrere benötigte Informationen zum Versenden einer E-Mail fehlen!');
define('_USERS_SEARCHANDMAILUSERS', 'Benutzer suchen und anschreiben');
...
define('_USERS_NM_SEND2','Mails pro Vorgang');
