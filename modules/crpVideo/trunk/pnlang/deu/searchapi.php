...
define('_CRPVIDEO_SECTIONS', 'Videos');
define('_CRPVIDEO_SEARCH', 'Videosuche');
define('_CRPVIDEO_SEARCHRESULTS', 'Video gefunden');
define('_CRPVIDEO_SEACHNONEFOUND', 'keine Videos gefunden');
