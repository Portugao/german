...
define('_MENUTREE_BLOCKPERMISSIONS_HINT','Es können für bestimmte Optionen erweiterte Rechte vergeben (Standard ist "Editieren"). Unten steht eine Liste dieser Optionen.');
