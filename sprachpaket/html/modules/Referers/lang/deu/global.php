...
// Purpose of file: language defines.
// ----------------------------------------------------------------------
//
...
define('_REFERERSDELNOAUTH','Keine Authorisierung, Referer zu löschen');
define('_REFERERSNOAUTH','Keine Authorisierung für Referer');
define('_TOTAL','Insgesamt:');
define('_URL','URL');
define('_WHOLINKS','Folgende Seiten haben Links auf uns gesetzt');
?>