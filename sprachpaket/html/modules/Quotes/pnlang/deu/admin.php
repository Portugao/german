...
define('_QUOTESADDNOAUTH','Keine Authorisierung, Zitate hinzuzufügen');
define('_QUOTESDELNOAUTH','Keine Authorisierung, Zitate zu löschen');
define('_QUOTESEDITNOAUTH','Keine Authorisierung, Zitate zu editieren');
define('_QUOTESNOAUTH','Keine Authorisierung, auf Zitate zuzugreifen');
