...
define('_MODIFYUSERSADDNOAUTH','Keine Authorisierung, Benutzer hinzuzufügen');
define('_MODIFYUSERSDELNOAUTH','Keine Authorisierung, Benutzer zu löschen');
define('_MODIFYUSERSEDITNOAUTH','Keine Authorisierung, Benutzer zu editieren');
define('_MODIFYUSERSNOAUTH','Keine Authorisierung, Benutzer zu modifizieren');
