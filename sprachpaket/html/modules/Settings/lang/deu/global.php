...
define('_INTRANETOPT','Intranet-Betrieb');
define('_INTRANETWARNING','Der Intranet-Modus sollte nur verwendet werden, wenn keine vollständige Domain-Installation (z.B. www.meineseite.de) möglich ist.  Im Intranet-Modus fehlen einige wichtige Sicherheitsbeschränkungen von Postnuke, er wird nur für den Betrieb innerhalb eines privaten, mit Firewall geschützten, Netzwerkes ohne Zugriff von außen empfohlen');
