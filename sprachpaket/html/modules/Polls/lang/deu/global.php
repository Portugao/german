...
define('_POLLSADDNOAUTH','Keine Autorisierung, Umfragen hinzuzufügen');
define('_POLLSADMIN','Umfrage-Administration');
define('_POLLSCONF','Umfrage-Konfiguration');
define('_POLLSDELNOAUTH','Keine Autorisierung, Umfragen zu löschen');
define('_POLLSEDITNOAUTH','Keine Autorisierung, Umfragen zu editieren');
define('_POLLSNOAUTH','Keine Autorisierung, auf Umfragen zuzugreifen');
