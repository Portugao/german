...
define('_POLLSADDNOAUTH','Keine Authorisierung, Umfragen hinzuzufügen');
define('_POLLSADMIN','Umfrage-Administration');
define('_POLLSCONF','Umfrage-Konfiguration');
define('_POLLSDELNOAUTH','Keine Authorisierung, Umfragen zu löschen');
define('_POLLSEDITNOAUTH','Keine Authorisierung, Umfragen zu editieren');
define('_POLLSNOAUTH','Keine Authorisierung, auf Umfragen zuzugreifen');
