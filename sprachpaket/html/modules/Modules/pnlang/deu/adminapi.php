...
define('_MODCHANGESTATEFAILED','Fehler! Änderung des Modul-Status fehlgeschlagen');
define('_MODNOSUCHMOD','Fehler! Kein solches Modul');
define('_MODULESAPIINVALIDSTATETRANSITIO','Fehler! Status-Übergang nicht möglich');
