...
define('_RECOMMENDUSFSITENAME','Seitenname:');
define('_RECOMMENDUSFSITEURL','URL zur Seite:');
define('_RECOMMENDUSFREFERENCE','Die Empfehlung für diese Seite wurde gesendet an');
define('_RECOMMENDUSTHANKSREC','Danke für die Weiterempfehlung!');
define('_RECOMMENDUSRECOMMENDITEM', 'Diese Beitrag weiterempfehlen');
define('_RECOMMENDUSTOAFRIED', 'an einen Freund');
