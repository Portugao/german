...
define('_UPG_DESCRIPTION', 'Dieses Skript aktualisiert PostNuke 0.764 auf die aktuelle Version. Aktualisierungen von älteren Veröffentlichungen werden nicht unterstützt.');
...
define('_UPG_BLOCKSTABLEUPGRADED', 'Tabelle -Blocks- aktualisiert');
define('_UPG_RESETTHEMETOEXTRALITE', 'Theme auf ExtraLite zurücksetzen');
define('_UPG_DUDMIGRATED', 'Benutzerattribute migriert');
define('_UPG_SEARCHMODULEREINSTALLED', 'Suchmodul wiederinstalliert');
define('_UPG_FOOTERINFO', 'Bitte die <a href="docs/upgrade.html">Upgradeanleitung</a> beachten. Weitere deutschsprachige Informationen gibt es auch unter <a href="http://support.pn-cms.de">support.pn-cms.de</a>');
...
define('_UPG_STARTUPGRADE', 'Hier klicken, um den Upgradeprozess zu starten.');
...
define('_UPG_INSTALLNEWMODULES', 'Installiere neue Systemmodule');
...
define('_UPG_GOTOADMINPANEL', 'Administration für <a href="%s">%s</a> aufrufen');
