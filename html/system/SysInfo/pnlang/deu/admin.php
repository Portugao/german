...
define('_SYSINFO_EXTMYSQL', 'Zikula kann mit dieser Datenbank verwendet werden, wenn diese Erweiterung geladen ist');
define('_SYSINFO_EXTMYSQLI', 'Zikula kann mit dieser Datenbank verwendet werden, wenn diese Erweiterung geladen ist');
