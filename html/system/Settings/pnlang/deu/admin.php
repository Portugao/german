...
define('_HTMLWARNING','HINWEIS: Um das Risiko von Cross-Site-Scripting zu minimieren sollte - insbesondere bei Freigabe von Tags mit Parametern - der safehtml-Outputfilter im SecurityCenter aktiviert werden.');
...
define('_METATAGSETTINGS', 'Meta-Keywords');
...
define('_STARTARGSDESCR', 'kommasepariert (name=value,name2=value2)');
