...
define('_MODULE_VARS_001', 'Site name');
define('_MODULE_VARS_002', 'logo.gif');
define('_MODULE_VARS_003', 'Site description');
...
define('_MODULE_VARS_011', 'Anonymous');
