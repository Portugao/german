...
define('_USERS_INVALIDREGCODE','Fehler! Ungültiger Registrierungscode');
...
define('_USERS_NOUSERINFOFOUND','Fehler! Keine korrespondierenden Benutzerinformationen gefunden');
define('_USERS_PASSWORDMAILED','Kennwort für %uname% wurde gesendet');
define('_USERS_PASSWORDREQUIRED','Bitte Kennwort eingeben');
define('_USERS_PPROFILEMODULENOTAVAILABLE','Fehler! Bitte installieren Sie vorher das PostNuke\'s Profile Modul!');
