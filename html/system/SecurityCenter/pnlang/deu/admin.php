...
define('_SECURITYCENTER_KEYEXPIRY', 'Zeitlimit für Authkeys in Sekunden (default 0)');
...
define('_SECURITYCENTER_SIGNINGKEY', 'Signatur Key');
...
define('_SECURITYCENTER_GC_PROBABILITY', 'Garbage collection probability');
...
define('_SECURITYCENTER_SESSIONNAME', 'Session-Cookie Name');
